...
public class DirectoresCustomAdapter extends RecyclerView.Adapter<DirectoresCustomAdapter.ViewHolder> {

    private ArrayList<Directores> dataSet;
    private Activity baseActivity;

    public DirectoresCustomAdapter(ArrayList<Directores> data, Activity baseActivity) {
        this.dataSet = data;
    ...
    @Override
    public void onBindViewHolder(@NonNull DirectoresCustomAdapter.ViewHolder holder, int position) {

        Directores dato = dataSet.get(position);
        holder.mainTitle.setText("ID: "+ dato.getId() + " | " +dato.getNombre() + " " + dato.getApellido_paterno() + " " + dato.getApellido_materno());
        holder.subTitle.setText("Peliculas_id: " + dato.getPeliculas_id());
        holder.dato = dato;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            deleteButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("Origen", "Directores");
