...
public class DistribuidoresCustomAdapter extends RecyclerView.Adapter<DistribuidoresCustomAdapter.ViewHolder> {

    private ArrayList<Distribuidores> dataSet;
    private Activity baseActivity;

    public DistribuidoresCustomAdapter(ArrayList<Distribuidores> data, Activity baseActivity) {
        this.dataSet = data;
    ...
    @Override
    public void onBindViewHolder(@NonNull DistribuidoresCustomAdapter.ViewHolder holder, int position) {

        Distribuidores dato = dataSet.get(position);
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            deleteButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("Origen", "Distribuidores");
